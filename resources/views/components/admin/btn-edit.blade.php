<div class="flex items-center gap-4">
    <a
        ...
        class="group relative z-[1] w-fit rounded-[10px]
            ...
            phone:px-3 phone:py-3 lg-phone:px-6 lg-phone:py-4
    ...
    <button
        type="{{ $type }}"
        class="group relative z-[1] w-fit rounded-[10px]
            flex items-center bg-blueBi overflow-hidden 
            phone:px-3 phone:py-3 lg-phone:px-6 lg-phone:py-4">
        <span
            class="w-[300px] h-[300px] absolute -z-[1] top-1/2 left-1/2
            -translate-x-1/2 -translate-y-1/2 scale-0 rounded-full
    ...
    <a
        href="{{ $hapus }}"
        class="group relative z-[1] w-fit rounded-[10px]
            flex items-center bg-redBi overflow-hidden 
            phone:px-3 phone:py-3 lg-phone:px-6 lg-phone:py-4">
        <span
            class="w-[300px] h-[300px] absolute -z-[1] top-1/2 left-1/2
            -translate-x-1/2 -translate-y-1/2 scale-0 rounded-full
            ease-linear duration-300 group-hover:bg-[#E74C5C] group-hover:scale-100"></span>
        <span
            class="relative z-[2] text-white
            phone:text-xs lg-phone:text-sm 
            font-medium tracking-[3.4px] uppercase">
